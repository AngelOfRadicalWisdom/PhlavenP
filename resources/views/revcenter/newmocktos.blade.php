...
<!-- <div class="w3-display-middle"> --><center>
    <h1 class="w3-jumbo w3-animate-top">&nbsp; Mock Exam TOS</h1><br>
...
<?php echo csrf_field() ?>
        ...
        <table style="margin: 0px auto;width:80%">
                    <input type="hidden" name="type" value="MOCK"><br>
            <tr>
                    ...
                    @if($node->chapter_ID == $lesson->chapter_ID)
                        <tr>
                            ...
                            <td><input type="hidden"  name="entry[<?php echo $lessonentrycounter?>][lesson]" value="{{$lesson->lesson_ID}}">
                                <input type="text" required size="5" name="entry[<?php echo $lessonentrycounter?>][questioncount]"></td>
                        </tr>
