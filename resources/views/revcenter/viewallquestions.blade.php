...
<body>
    ...
    <table style="margin:0 auto;width:80%;height:5%">
        <tr>
            <td style="text-align:left"><a href="<?php echo url('/revcenter/settings/node/viewlesson/'.$lesson->lesson_ID);?>">BACK</a></td>
            <td style="text-align:right">AM || <a href="<?php echo url('/revcenter/settings/lesson/'.$lesson->lesson_ID.'/viewquestionsPM');?>">PM</a> || <a href="<?php echo url('/revcenter/settings/lesson/'.$lesson->lesson_ID.'/newquestion');?>">ADD QUESTION</a></td>
        </tr>
    </table>
    ...
    <!-- <h5 class="w3-jumbo w3-animate-top">All new users are required to take a diagnostic exam</h5> -->
        ...
        <table style="margin: 0px auto;width:80%;color:black">
            ...
            @foreach($questionlist as $question)
                ...
                <td>{{substr($question->questionanswer->choice,0,20)}}...</td>
