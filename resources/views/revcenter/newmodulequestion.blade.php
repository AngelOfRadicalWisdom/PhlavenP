...
<body>
    ...
    <!-- <div class="w3-display-middle"> --><center>
        ...
        <hr style="width:50%;border-color:#006dcc">
        <form action="<?php echo url('/revcenter/settings/savequestion/'.$lesson_name)?>" method="post">
        <?php echo csrf_field()?>
        ...
        <tr>
            <td colspan="2"><hr style="width:100%;border-color:#006dcc"></td>
        </tr>
            <?php $choicecount=5; ?>
            ...
            <tr>
            <td>Choice:</td>
            <td><input type="text" name="choice[<?php echo $counter;?>][choice]" cols="25" rows="5"> </textarea></td>
            </tr>
            <tr>
            <td>Response:</td>
            <td><input type="text" name="choice[<?php echo $counter;?>][response]" cols="25" rows="5"> </textarea></td>
            </tr>
            <tr>
            <td colspan="2"><hr style="width:100%;border-color:#006dcc"></td>
            </tr>
