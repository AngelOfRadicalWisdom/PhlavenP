...
<body>
    ...
    <br>
        <h1 class="w3-jumbo w3-animate-top" style="color:black">Diagnostic</h1><br>
	...
	<form action="<?php echo url('diagnosticexam/answer')?>" method="post">
	<?php echo csrf_field()?>
    ...
    <!---->
            ...
            <table  class="table aligned-to-center profiletable" style="width:80%">
                    <input type="hidden" name='entry[<?php echo $counter; ?>][question]' value='<?php echo $question->questions->question_ID ?>'>
            <tr>
                <td colspan="3" style="color:black"><?php echo $counter;?>.)<br><br>{{$question->questions->question}}</td>
            </tr>
            <tr>
	...
	<!-- <table style="margin: 0px auto;">
        ...
        <tr>
            <td>Node ID:</td>
            <td><input type="text" placeholder="Node ID" name="nodeID" value="N-"></td>
        </tr>
